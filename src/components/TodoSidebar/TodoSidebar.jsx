...
const TodoSidebar = ({searchTasks, setSearchQuery}) => {
  ...
  return (
    ...
    <div className="todo-sidebar__search">
      <svg className="todo-sidebar__search-icon" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" viewBox="0 0 1024 1024">
      ...
      <input
        ...
        type="text"
        className="todo-sidebar__search-input"
